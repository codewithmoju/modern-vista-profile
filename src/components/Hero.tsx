...
const Hero = () => {
  return <section className="min-h-screen flex items-center justify-center gradient-bg relative overflow-hidden pt-20">
      ...
      <div className="container mx-auto px-4 py-20 relative z-10">
        ...
        duration: 0.5
          ...
          delay: 0.6
            ...
            <a href="#projects" className="group relative inline-flex items-center justify-center px-8 py-3 overflow-hidden font-medium rounded-lg shadow-md bg-theme-accent1 text-white transition-all duration-300 ease-out w-full md:w-auto">
              <span className="relative flex items-center gap-2 text-white font-medium">
                View Projects
                <ChevronRight className="w-4 h-4" />
              </span>
            </a>
            <a href="#contact" className="group relative inline-flex items-center justify-center px-8 py-3 font-medium text-theme-accent2 bg-transparent border-2 border-theme-accent2 rounded-lg hover:bg-theme-accent2 hover:text-black transition-colors duration-300 ease-out w-full md:w-auto">
          ...
          delay: 0.8
            ...
            <a href="https://github.com/MuhammadMoaiz001" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">
              <Github size={24} />
            </a>
            <a href="https://twitter.com/M_Moaiz001" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">
              <Twitter size={24} />
            </a>
            <a href="https://www.linkedin.com/in/muhammadmoaiz" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">
              <Linkedin size={24} />
            </a>
          </motion.div>
        </motion.div>
